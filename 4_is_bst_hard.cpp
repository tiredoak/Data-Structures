/*
  ...
  binary search tree where a binary search tree is defined as one where all values
  its left branch are strictly less than the root and the values in the right branch 
